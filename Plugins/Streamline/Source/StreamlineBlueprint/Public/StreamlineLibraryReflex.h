...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Reflex (Streamline)", meta = (DisplayName = "Is NVIDIA Reflex Supported"))
	static STREAMLINEBLUEPRINT_API bool IsReflexSupported();

	UFUNCTION(BlueprintPure, Category = "Reflex (Streamline)", meta = (DisplayName = "Query NVIDIA Reflex Support"))
	static STREAMLINEBLUEPRINT_API UStreamlineReflexSupport QueryReflexSupport();


		UFUNCTION(BlueprintCallable, Category = "Reflex (Streamline)", meta = (DisplayName = "Set Reflex mode"))
	static STREAMLINEBLUEPRINT_API void SetReflexMode(const UStreamlineReflexMode Mode);
	
	UFUNCTION(BlueprintPure, Category = "Reflex (Streamline)", meta = (DisplayName = "Get Reflex mode"))
	static STREAMLINEBLUEPRINT_API UStreamlineReflexMode GetReflexMode();


	UFUNCTION(BlueprintPure, Category = "Reflex (Streamline)", meta = (DisplayName = "Get default Reflex mode"))
	static STREAMLINEBLUEPRINT_API UStreamlineReflexMode GetDefaultReflexMode();

	UFUNCTION(BlueprintPure, Category = "Reflex (Streamline)", meta = (DisplayName = "Get Reflex Game To Render Latency (ms)"))
	static STREAMLINEBLUEPRINT_API float GetGameToRenderLatencyInMs();
	UFUNCTION(BlueprintPure, Category = "Reflex (Streamline)", meta = (DisplayName = "Get Reflex Game Latency (ms)"))
	static STREAMLINEBLUEPRINT_API float GetGameLatencyInMs();
	UFUNCTION(BlueprintPure, Category = "Reflex (Streamline)", meta = (DisplayName = "Get Reflex Render Latency (ms)"))
