...
{
#if WITH_STREAMLINE
	return QueryReflexSupport() == UStreamlineReflexSupport::Supported;
#else
	return false;
#endif
}
...
UStreamlineReflexSupport UStreamlineLibraryReflex::QueryReflexSupport()
{
	...
	return bIsMaxTickRateHandlerEnabled && bIsLatencyMarkerModuleEnabled ? UStreamlineReflexSupport::Supported : UStreamlineReflexSupport::NotSupported;
#endif
	return UStreamlineReflexSupport::NotSupported;
}
