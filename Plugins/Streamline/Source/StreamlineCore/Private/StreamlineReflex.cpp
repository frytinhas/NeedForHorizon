...
bool FStreamlineLatencyBase::IsStreamlineReflexSupported()
{
	...
	if (!bStreamlineReflexSupportedInitialized)
	{
		...
		UE_LOG(LogStreamline, Log, TEXT("%s Streamline Reflex supported %u (%s)"), ANSI_TO_TCHAR(__FUNCTION__), bStreamlineReflexSupported,
			ANSI_TO_TCHAR(sl::getResultAsStr(Result)));
